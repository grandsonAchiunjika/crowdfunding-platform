...
# SECRET_KEY, DEBUG, ALLOWED_HOSTS, and DATABASE_URL from the .env file
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",  # Change this to your frontend's URL
...
# Debug toolbar configuration for local dev
